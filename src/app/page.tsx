        ...
        innerHTML: JSON.stringify([
          ...
          },
          {
            ...
            itemListElement: [
              {
                "@type": "Offer",
                itemOffered: { "@type": "Product", name: "Jeans (Men/Women)" },
              },
              {
                "@type": "Offer",
                itemOffered: { "@type": "Product", name: "T-shirts & Tops" },
              },
              {
                "@type": "Offer",
                itemOffered: {
              ...
              {
                "@type": "Offer",
                itemOffered: { "@type": "Product", name: "Kidswear" },
              },
              {
                "@type": "Offer",
                itemOffered: {
...
存在此问题的内容无效。无效内容无法在 Google 搜索中显示为富媒体搜索结果
      ...
      <div className="flex flex-col gap-8">
        ...
        >
          ...
          <div className="flex flex-col items-start ml-4 sm:ml-16 lg:ml-60 p-4 relative z-10">
            ...
            <h2 className="text-white text-sm sm:text-base lg:text-lg leading-relaxed w-full sm:w-[320px] lg:w-[400px] ">
              We offer a wide range of authentic clothing at unbeatable prices,
              ensuring that you can find exactly what you need. Quality,
              variety, and affordability—everything you’re looking for, all in
              one place.
            </h2>
          </div>
        </section>
        ...
        <div className="max-w-[100%] sm:max-w-[600px] lg:max-w-[800px] mx-auto text-left p-4 mb-4">
          ...
          <p>
            In our craft, mastery comes from dedication. We believe that
            excellence in manufacturing demands precision, patience, and an
            unwavering commitment to every detail. From fabric selection to
            final stitching, we uphold a spirit of craftsmanship that ensures
            every garment meets the highest standards.
          </p>
          <h2
            className="text-lg sm:text-xl font-bold mb-2 mt-6"
            aria-label="Trading"
          >
            Trading
          </h2>
          <p>
            Trust is the foundation of our business. We believe that lasting
            partnerships are built on honesty, reliability, and a genuine
            understanding of our clients’ needs. By offering a wide variety of
            styles at competitive prices, we ensure that our customers can
            source with confidence, knowing they are getting both value and
            peace of mind.
          </p>
        </div>
      </div>
